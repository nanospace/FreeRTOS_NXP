LPCXpresso54618 USB Virtual Comm port Example
======================================
...
a new serial port. Using a serial terminal communication between the host and LPCXpresso54618 can be established.
