LPCXpresso54618 USB Audio DMIC Example
==========================

Example description
-------------------
The example shows how to use USBD ROM stack to create and USB AUDIO class
device. This device supports 2 channel audio in (MIC/LINE_IN).
Default supported format is 16000 Hz sampling rate with 16-bit sample width. For recording audio open the voice recording application (example in windows 10 user Voice Recorder App), to record audio from analog line input.
