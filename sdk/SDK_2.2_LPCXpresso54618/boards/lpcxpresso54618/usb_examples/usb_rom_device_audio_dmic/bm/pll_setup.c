...
void audio_trim_up(void)
{
    ...
    GPIO_TogglePinsOutput(GPIO, BOARD_LED_RED_GPIO_PORT, (0x01 << BOARD_LED_RED_GPIO_PIN));
#endif
}
...
#if !defined(LOWPOWEROPERATION)
    GPIO_TogglePinsOutput(GPIO, BOARD_LED_GREEN_GPIO_PORT, (0x01 << BOARD_LED_GREEN_GPIO_PIN));
#endif
}
