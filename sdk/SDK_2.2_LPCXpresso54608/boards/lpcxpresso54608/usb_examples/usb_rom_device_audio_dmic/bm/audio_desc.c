...
uint8_t USB_FsConfigDescriptor[] = {
    ...
    WBVAL(                             /* wTotalLength */
          USB_CONFIGURATION_DESC_SIZE + USB_INTERFACE_DESC_SIZE + AUDIO_CONTROL_INTERFACE_DESC_SZ(1) +
          AUDIO_INPUT_TERMINAL_DESC_SIZE + AUDIO_FEATURE_UNIT_DESC_SZ(1, 1) + AUDIO_OUTPUT_TERMINAL_DESC_SIZE +
    ...
    WBVAL(                              /* wTotalLength */
          AUDIO_CONTROL_INTERFACE_DESC_SZ(1) + AUDIO_INPUT_TERMINAL_DESC_SIZE + AUDIO_FEATURE_UNIT_DESC_SZ(1, 1) +
          AUDIO_OUTPUT_TERMINAL_DESC_SIZE),
    0x01,            /* bInCollection */
    USB_ADC_DMIC_IF, /* baInterfaceNr(1) */
    ...
    USB_INTERFACE_DESC_SIZE,       /* bLength */
    USB_INTERFACE_DESCRIPTOR_TYPE, /* bDescriptorType */
    USB_ADC_DMIC_IF,               /* bInterfaceNumber */
    0x00,                          /* bAlternateSetting */
    0x00,                          /* bNumEndpoints */
    USB_DEVICE_CLASS_AUDIO,        /* bInterfaceClass */
    ...
    0x03,                                /* bTerminalLink */
    0x00,                                /* bDelay */
    WBVAL(AUDIO_FORMAT_PCM8),            /* wFormatTag */
    /* Audio Type I Format */
    ...
    0x00,                               /* bmAttributes */
    0x00,                               /* bLockDelayUnits - msec based delay*/
    WBVAL(0x0000),                      /* wLockDelay - 5 msec delay requested*/
